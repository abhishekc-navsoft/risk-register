...
export class sharedService {
  ...
  COUNTRY_JSON: any = [
    ...
    { code: 'VI', code3: 'VIR', name: 'Virgin Islands', number: '+850' },
  ...
  tableSearch() {
    ...
    for (i = 0; i < tr.length; i++) {
      var alltags = tr[i].getElementsByTagName('td');
      isFound = false;
