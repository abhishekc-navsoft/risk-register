...
import { riskAddcategoryComponent } from './addriskcategory.component';

const routes: Routes = [
  {
    path: '',
    component: riskAddcategoryComponent,
  },
];
@NgModule({
  imports: [
  ...
  exports: [riskAddcategoryComponent],
  declarations: [riskAddcategoryComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA],
  providers: [TranslateService, TranslateStore],
})
export class riskAddCategoryModule {}
